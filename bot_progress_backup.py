...
from ai_brain.planner import ai_plan
        ...
        reply = client.chat.completions.create(
            ...
            messages=[
                {
                    "role":"system",
                    "content":"You are Sameer AI Manager. Reply in smart Hinglish like a real AI CTO assistant."
                },
                {
                    "role":"user",
                    "content":text
...
from ai_brain.idea_router import create_upgrade_task
...
app.add_handler(CommandHandler("health", lambda u,c: u.message.reply_text(health_report())))
app.add_handler(CommandHandler("health", lambda u,c: u.message.reply_text(health_report())))
...
async def upgrade(update, context):
    ...
    path=create_upgrade_task(bot,task)
